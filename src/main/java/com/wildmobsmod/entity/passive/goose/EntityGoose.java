...
public class EntityGoose extends EntityCreature implements IAnimals {
    ...
    public void setFlyingState(int state) {
        this.dataWatcher.updateObject(21, Byte.valueOf((byte) state));
    }
    ...
    public void setFlyingDirectionX(int x) {
        this.dataWatcher.updateObject(22, Byte.valueOf((byte) x));
    }
    ...
    public void setFlyingDirectionZ(int z) {
        this.dataWatcher.updateObject(23, Byte.valueOf((byte) z));
    }
    ...
    public void setFlyingTime(int time) {
        this.dataWatcher.updateObject(24, Byte.valueOf((byte) time));
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.spawnPosition == null || this.rand.nextInt(40) == 0
            ...
            for (int i = 0; i < 2500; ++i) {
                ...
                if (this.worldObj.getBlock(j, k - 1, l)
                    .getMaterial() == Material.water
                    && this.worldObj.getBlock(j, k, l)
                        .getMaterial() != Material.water) {
                    this.spawnPosition = new ChunkCoordinates(j, k, l);
                }

                if (this.worldObj.getBlock(j, m - 1, l) != Blocks.water && this.worldObj.getBlock(j, m - 1, l)
                    .isNormalCube() && this.rand.nextInt(4) == 0 && this.onGround == false) {
                    this.spawnPosition = new ChunkCoordinates(j, k, l);
                }
            }
        }
    ...
    protected void checkBlockCollision() {
        if (this.rotationYaw < 45 && this.worldObj
            .getBlock(
            ...
            && this.worldObj
                .getBlock(
                    MathHelper.floor_double(this.posX) - 1,
                    MathHelper.floor_double(this.posY),
                    MathHelper.floor_double(this.posZ))
                .isNormalCube()) {
                    this.setFlyingState(0);
                } else
            if (this.rotationYaw >= 135 && this.rotationYaw < 225
                && this.worldObj
                    .getBlock(
                        MathHelper.floor_double(this.posX),
                        MathHelper.floor_double(this.posY),
                ...
                if (this.rotationYaw >= 225 && this.rotationYaw < 315
                    && this.worldObj
                        .getBlock(
                            MathHelper.floor_double(this.posX) + 1,
                            MathHelper.floor_double(this.posY),
                    ...
                    if (this.rotationYaw >= 315 && this.worldObj
                        .getBlock(
                            MathHelper.floor_double(this.posX),
                            MathHelper.floor_double(this.posY),
                            MathHelper.floor_double(this.posZ) + 1)
        ...
        if (this.getFlyingState() == 1) {
            ...
            if (this.worldObj
                .getBlock(
                    ...
                    MathHelper.floor_double(this.posZ))
                .getMaterial() == Material.water && !this.worldObj.isRemote) {
                this.setFlyingState(0);
            }
                    ...
                    && this.worldObj
                        ...
                        .getMaterial() != Material.water) {
                            ...
                            if (this.rand.nextFloat() < 0.00015F && !this.worldObj.isRemote) {
                                ...
                                this.playSound(
                                    "wildmobsmod:entity.goose.flying",
                                    this.getSoundVolume(),
                                    this.getSoundPitch());
                            }
                            if (this.fallTimer < 5 && !this.worldObj
                                .getBlock(
                                    MathHelper.floor_double(this.posX),
                                    MathHelper.floor_double(this.posY) - 1,
                                    MathHelper.floor_double(this.posZ))
    ...
    public boolean getCanSpawnHere() {
        if (this.worldObj.checkNoEntityCollision(this.boundingBox)
            ...
            return block.isNormalCube() || block.getMaterial() == Material.water
                || (block1.getMaterial() == Material.water && block.getMaterial() != Material.water);
        }
        return false;
    }
}
